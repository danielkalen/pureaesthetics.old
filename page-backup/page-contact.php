	...
	<section class="section section-map">
		<div class="site-wrap">
			<div class="mobile-site-wrap">
				...
				<div class="map"><div id="map-canvas" style="width:730px;height:337px;"></div></div>
		...
		<div class="site-wrap">
			<!-- <div class="vertical-align"> -->
					...
					<div class="policy">
						...
						<p class="policy-desc">If you arrive late, your session may be shortened in order to accommodate others whose appointments follow yours. Depending upon how late you arrive, your therapist will then determine if there is enough time remaining to start a treatment. Regardless of the length of the treatment actually given, you will be responsible for the full session. Out of respect and considerations to your therapist and other customers, please plan accordingly and be on time.</p>
					</div>
				</div>
			<!-- </div> -->
		</div>
